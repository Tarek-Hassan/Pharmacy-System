...
<body class="hold-transition login-page" style="background-image: url({{asset('control')}}/media/img/bg/bg6.jpg);">
    <div class="login-box">
    <div class="m-login__logo my-3">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg"> Sign in As a PHARMACY to start your session</p>
                @include('admin.error')
                @include('admin.tab')
                ...
                @if (Route::has('password.request'))
								<a href="{{ route('pharmacy.password.request') }}"  class="m-link">
									Forget Password ?
								</a>
								@endif
                </p>
